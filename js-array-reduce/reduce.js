...
function vowelCount(str) {
    const vowels = 'aeiou';
    str = str.toLowerCase();
    const phrase = Array.from(str);
    return phrase.reduce((accumulator, currentVal) => {
        //if the current value is a vowel and it doesnt exist in the accumulator object , add as key to the object with value of 1
